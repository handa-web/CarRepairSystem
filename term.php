...
<head>
	...
	<title>利用規約 | car_repair予約システム</title>
	<!-- css -->
...
<main id="main">
	...
	<section id="text_box">
		...
		<p class="">この利用規約（以下，「本規約」といいます。）は，<?=h($shop['shop_name']);?>（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>

		<section>
			<h3 class="title">第1条（適用）</h3>
			<ol>
		...
		<section>
			<h3 class="title">第3条（メールアドレスおよびパスワードの管理）</h3>
			<ol>
				<li>ユーザーは，自己の責任において，本サービスのメールアドレスおよびパスワードを適切に管理するものとします。</li>
				<li>ユーザーは，いかなる場合にも，メールアドレスおよびパスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。当社は，メールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのメールアドレスを登録しているユーザー自身による利用とみなします。</li>
				<li>メールアドレス及びパスワードが第三者によって使用されたことによって生じた損害は，当社に故意又は重大な過失がある場合を除き，当社は一切の責任を負わないものとします。</li>
			</ol>
		</section>
		...
		<section>
			<h3 class="title">第6条（本サービスの提供の停止等）</h3>
			<ol>
				<li>
		...
		<section>
			<h3 class="title">第7条（利用制限および登録抹消）</h3>
			<ol>
				<li>
		...
		<section>
			<h3 class="title">第8条（退会）</h3>
			<p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>
		</section>

		<section>
			<h3 class="title">第9条（保証の否認および免責事項）</h3>
			<ol>
		...
		<section>
			<h3 class="title">第10条（サービス内容の変更等）</h3>
			<p>当社は，本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
		</section>

		<section>
			<h3 class="title">第11条（利用規約の変更）</h3>
			<ol>
				<li>当社は、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。</li>
				<li>当社はユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨及び変更後の本規約の内容並びにその効力発生時期を通知します。</li>
			</ol>
		</section>

		<section>
			<h3 class="title">第12条（個人情報の取扱い）</h3>
			<p>当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
		</section>

		<section>
			<h3 class="title">第13条（通知または連絡）</h3>
		...
		<section>
			<h3 class="title">第14条（権利義務の譲渡の禁止）</h3>
			<p>ユーザーは，当社の事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
		</section>

		<section>
			<h3 class="title">第15条（準拠法・裁判管轄）</h3>
			<ol>
